...
public class SK4000018958 {
    public static void main(String[] args) throws Exception {
        ...
        Date issueDate = new Date(21, Month.April, 2021);
        Date maturityDate = new Date(21, Month.April, 2036);
        ...
        System.out.printf("\n\n------------------------COMPARE-------------------------\n");
        System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 103.181\n", cleanPrice);
        System.out.printf("Invoice Price =>  Quantlib: %.7f | Sample: 103.2909315\n", dirtyPrice);
        System.out.printf("Accrued Days =>  Quantlib: %d | Sample: 107\n", BondFunctions.accruedDays(bond));
        System.out.printf("Accrued Interest =>  Quantlib: %.8f | Sample: 0.10993151\n", bond.accruedAmount());
        System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 208.862601\n",
                BondFunctions.convexity(bond, yieldRate, settlementDate));
        System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 14.3297497\n",
                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
        System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 14.30742411\n",
