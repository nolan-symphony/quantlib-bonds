...
public class ES0000012I24 {
    public static void main(String[] args) throws Exception {
        ...
        Date maturityDate = new Date(30, Month.July, 2037);
        Double coupon = 0.0085;
        ...
        System.out.printf("\n\n------------------------COMPARE-------------------------\n");
        System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 102.857\n", cleanPrice);
        System.out.printf("Invoice Price =>  Quantlib: %.7f | Sample: 102.8733014\n", dirtyPrice);
        System.out.printf("Accrued Days =>  Quantlib: %d | Sample: 7\n", BondFunctions.accruedDays(bond));
        System.out.printf("Accrued Interest =>  Quantlib: %.8f | Sample: 0.01630137\n", bond.accruedAmount());
        System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 234.811513\n",
                BondFunctions.convexity(bond, yieldRate, settlementDate));
        System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 15.02553265\n",
                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
        System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 14.92686293\n",
