...
public class PTOTEOOE0033 {
        public static void main(String[] args) throws Exception {
                ...
                Date issueDate = new Date(14, Month.April, 2021);
                Date maturityDate = new Date(17, Month.October, 2031);
                Double coupon = 0.003;
                ...
                System.out.printf("\n\n------------------------COMPARE-------------------------\n");
                System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 102.03414499\n", cleanPrice);
                System.out.printf("Invoice Price =>  Quantlib: %.7f | Sample: 102.12669863\n", dirtyPrice);
                System.out.printf("Accrued Days =>  Quantlib: %d | Sample: 114\n", BondFunctions.accruedDays(bond));
                System.out.printf("Accrued Interest =>  Quantlib: %.8f | Sample: 0.09369863\n", bond.accruedAmount());
                System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 101.951885\n",
                                BondFunctions.convexity(bond, yieldRate, settlementDate));
                System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 10.04934512\n",
                                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
                System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 10.03935389\n",
