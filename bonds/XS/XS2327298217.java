...
public class XS2327298217 {
    public static void main(String[] args) throws Exception {
        ...
        Date maturityDate = new Date(06, Month.April, 2025);
        Double coupon = 0.00;
        ...
        System.out.printf("\n\n------------------------COMPARE-------------------------\n");
        System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 100.6156177\n", cleanPrice);
        System.out.printf("Invoice Price =>  Quantlib: %.7f | Sample: 100.616\n", dirtyPrice);
        ...
        System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 13.439985\n",
                BondFunctions.convexity(bond, yieldRate, settlementDate));
        System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 3.66605849\n",
                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
        System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 3.67220525\n",
