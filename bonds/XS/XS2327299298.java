...
public class XS2327299298 {
    public static void main(String[] args) throws Exception {
        ...
        Date maturityDate = new Date(06, Month.April, 2028);
        Double coupon = 0.0025;
        ...
        System.out.printf("\n\n------------------------COMPARE-------------------------\n");
        System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 101.1972194\n", cleanPrice);
        System.out.printf("Invoice Price =>  Quantlib: %.7f | Sample: 101.2805616\n", dirtyPrice);
        System.out.printf("Accrued Days =>  Quantlib: %d | Sample: 122\n", BondFunctions.accruedDays(bond));
        System.out.printf("Accrued Interest =>  Quantlib: %.8f | Sample: 0.08356164\n", bond.accruedAmount());
        System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 43.980467\n",
                BondFunctions.convexity(bond, yieldRate, settlementDate));
        System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 6.61503398\n",
                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
        System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 6.6104106\n",
