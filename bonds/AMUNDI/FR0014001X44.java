...
public class FR0014001X44 {
    public static void main(String[] args) throws Exception {
        ...
        Date maturityDate = new Date(07, Month.June, 2029);
        Double coupon = 0.0;
        ...
        System.out.printf("\n\n------------------------COMPARE-------------------------\n");
        System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 97.24\n", cleanPrice);
        System.out.printf("Invoice Price =>  Quantlib: %.7f | Sample: 97.24\n", dirtyPrice);
        System.out.printf("Accrued Days =>  Quantlib: %d | Sample: 59\n", BondFunctions.accruedDays(bond));
        System.out.printf("Accrued Interest =>  Quantlib: %.7f | Sample: 0\n", bond.accruedAmount());
        System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 61.401203\n",
                BondFunctions.convexity(bond, yieldRate, settlementDate));
        System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 7.835892\n",
                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
        System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 7.80795467\n",
