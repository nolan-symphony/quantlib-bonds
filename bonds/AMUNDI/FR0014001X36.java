...
public class FR0014001X36 {
    public static void main(String[] args) throws Exception {
        ...
        Date issueDate = new Date(18, Month.March, 2021);
        Date maturityDate = new Date(21, Month.June, 2029);
        Double coupon = 0.0;
        ...
        System.out.printf("\n\n------------------------COMPARE-------------------------\n");
        System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 98.4591147\n", cleanPrice);
        System.out.printf("Invoice Price =>  Quantlib: %.7f | Sample: 98.45\n", dirtyPrice);
        System.out.printf("Accrued Days =>  Quantlib: %d | Sample: 45\n", BondFunctions.accruedDays(bond));
        System.out.printf("Accrued Interest =>  Quantlib: %.7f | Sample: 0\n", bond.accruedAmount());
        System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 62.003383\n",
                BondFunctions.convexity(bond, yieldRate, settlementDate));
        System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 7.87422271\n",
                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
        System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 7.85861835\n",
