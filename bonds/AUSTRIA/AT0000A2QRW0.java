...
public class AT0000A2QRW0 {
    public static void main(String[] args) throws Exception {
        ...
        Date maturityDate = new Date(20, Month.April, 2025);
        Double coupon = 0.00;
        ...
        System.out.printf("\n\n------------------------COMPARE-------------------------\n");
        System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 102.672293\n", cleanPrice);
        System.out.printf("Invoice Price =>  Quantlib: %.7f | Sample: 102.673\n", dirtyPrice);
        ...
        System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 13.722499\n",
                BondFunctions.convexity(bond, yieldRate, settlementDate));
        System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 3.70438919\n",
                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
        System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 3.73086434\n",
