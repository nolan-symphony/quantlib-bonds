...
public class US12116LAA70 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("\n\n------------------------COMPARE-------------------------\n");
        System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 105.7503071\n", cleanPrice);
        System.out.printf("Invoice Price =>  Quantlib: %.8f | Sample: 107.8333333\n", dirtyPrice);
        ...
        System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 34.386039\n",
                BondFunctions.convexity(bond, yieldRate, settlementDate));
        System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 5.50207492\n",
                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
        System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 5.36214348\n",
