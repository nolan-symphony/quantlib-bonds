...
public class US912810SX72 {
    public static void main(String[] args) throws Exception {
        ...
        Date maturityDate = new Date(15, Month.May, 2051);
        Double coupon = 0.02375;
        ...
        System.out.printf("\n\n------------------------COMPARE-------------------------\n");
        System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 111.78125\n", cleanPrice);
        System.out.printf("Invoice Price =>  Quantlib: %.8f | Sample: 112.310462\n", dirtyPrice);
        System.out.printf("Accrued Days =>  Quantlib: %d | Sample: 82\n", BondFunctions.accruedDays(bond));
        System.out.printf("Accrued Interest =>  Quantlib: %.7f | Sample: 0.52921196\n", bond.accruedAmount());
        System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 581.681252\n",
                BondFunctions.convexity(bond, yieldRate, settlementDate));
        System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 21.92651017\n",
                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
        System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 21.72468626\n",
