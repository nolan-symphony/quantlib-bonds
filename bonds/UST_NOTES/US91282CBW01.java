...
public class US91282CBW01 {
    public static void main(String[] args) throws Exception {
        ...
        Date issueDate = new Date(30, Month.April, 2021);
        Date maturityDate = new Date(30, Month.April, 2026);
        Double coupon = 0.0075;
        ...
        System.out.printf("\n\n------------------------COMPARE-------------------------\n");
        System.out.printf("Clean Price =>  Quantlib: %.8f | Sample: 100.30859375\n", cleanPrice);
        System.out.printf("Invoice Price =>  Quantlib: %.8f | Sample: 100.50628397\n", dirtyPrice);
        System.out.printf("Accrued Days =>  Quantlib: %d | Sample: 97\n", BondFunctions.accruedDays(bond));
        System.out.printf("Accrued Interest =>  Quantlib: %.7f | Sample: 0.19769022\n", bond.accruedAmount());
        System.out.printf("Convexity =>  Quantlib: %.6f | Sample: 21.886992\n",
                BondFunctions.convexity(bond, yieldRate, settlementDate));
        System.out.printf("Simple Duration =>  Quantlib: %.8f | Sample: 4.65086497\n",
                BondFunctions.duration(bond, yieldRate, Duration.Type.Simple));
        System.out.printf("Modified duration =>  Quantlib: %.8f | Sample: 4.63502153\n",
