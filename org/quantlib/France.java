...
public class France extends Calendar {
  ...
  protected France(long cPtr, boolean cMemoryOwn) {
    super(QuantLibJNI.France_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  protected static long getCPtr(France obj) {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        QuantLibJNI.delete_France(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public France(France.Market m) {
    this(QuantLibJNI.new_France__SWIG_0(m.swigValue()), true);
  }

  public France() {
    this(QuantLibJNI.new_France__SWIG_1(), true);
  }

  public final static class Market {
    public final static France.Market Settlement = new France.Market("Settlement");
    public final static France.Market Exchange = new France.Market("Exchange");
