...
public class ZeroCouponInflationSwap extends Swap {
  ...
  public ZeroCouponInflationSwap(Swap.Type type, double nominal, Date start, Date maturity, Calendar calendar, BusinessDayConvention convention, DayCounter dayCounter, double fixedRate, ZeroInflationIndex index, Period lag, boolean adjustInfObsDates, Calendar infCalendar, BusinessDayConvention infConvention) {
    this(QuantLibJNI.new_ZeroCouponInflationSwap__SWIG_4(type.swigValue(), nominal, Date.getCPtr(start), start, Date.getCPtr(maturity), maturity, Calendar.getCPtr(calendar), calendar, convention.swigValue(), DayCounter.getCPtr(dayCounter), dayCounter, fixedRate, ZeroInflationIndex.getCPtr(index), index, Period.getCPtr(lag), lag, adjustInfObsDates, Calendar.getCPtr(infCalendar), infCalendar, infConvention.swigValue()), true);
  }

  public ZeroCouponInflationSwap(Swap.Type type, double nominal, Date start, Date maturity, Calendar calendar, BusinessDayConvention convention, DayCounter dayCounter, double fixedRate, ZeroInflationIndex index, Period lag, boolean adjustInfObsDates, Calendar infCalendar) {
    this(QuantLibJNI.new_ZeroCouponInflationSwap__SWIG_5(type.swigValue(), nominal, Date.getCPtr(start), start, Date.getCPtr(maturity), maturity, Calendar.getCPtr(calendar), calendar, convention.swigValue(), DayCounter.getCPtr(dayCounter), dayCounter, fixedRate, ZeroInflationIndex.getCPtr(index), index, Period.getCPtr(lag), lag, adjustInfObsDates, Calendar.getCPtr(infCalendar), infCalendar), true);
  }

  public ZeroCouponInflationSwap(Swap.Type type, double nominal, Date start, Date maturity, Calendar calendar, BusinessDayConvention convention, DayCounter dayCounter, double fixedRate, ZeroInflationIndex index, Period lag, boolean adjustInfObsDates) {
    this(QuantLibJNI.new_ZeroCouponInflationSwap__SWIG_6(type.swigValue(), nominal, Date.getCPtr(start), start, Date.getCPtr(maturity), maturity, Calendar.getCPtr(calendar), calendar, convention.swigValue(), DayCounter.getCPtr(dayCounter), dayCounter, fixedRate, ZeroInflationIndex.getCPtr(index), index, Period.getCPtr(lag), lag, adjustInfObsDates), true);
  }

  public ZeroCouponInflationSwap(Swap.Type type, double nominal, Date start, Date maturity, Calendar calendar, BusinessDayConvention convention, DayCounter dayCounter, double fixedRate, ZeroInflationIndex index, Period lag) {
    this(QuantLibJNI.new_ZeroCouponInflationSwap__SWIG_7(type.swigValue(), nominal, Date.getCPtr(start), start, Date.getCPtr(maturity), maturity, Calendar.getCPtr(calendar), calendar, convention.swigValue(), DayCounter.getCPtr(dayCounter), dayCounter, fixedRate, ZeroInflationIndex.getCPtr(index), index, Period.getCPtr(lag), lag), true);
  }
